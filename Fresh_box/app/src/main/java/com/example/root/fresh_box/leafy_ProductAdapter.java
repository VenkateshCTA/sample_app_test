...
public class leafy_ProductAdapter extends BaseAdapter {

	private List<leafy_Product> mProductList;
	private LayoutInflater mInflater;
	private boolean mShowQuantity;

	public leafy_ProductAdapter(List<leafy_Product> list, LayoutInflater inflater, boolean showQuantity) {
		mProductList = list;
		mInflater = inflater;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		leafy_Product curProduct = mProductList.get(position);
		...
		if (mShowQuantity) {
			item.productQuantity.setText("Quantity: " + leafy_ShoppingCartHelper.getProductQuantity(curProduct));
		} else {
			// Hid the view
