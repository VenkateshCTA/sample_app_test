...
public class ex_ProductAdapter extends BaseAdapter {

	private List<ex_Product> mProductList;
	private LayoutInflater mInflater;
	private boolean mShowQuantity;

	public ex_ProductAdapter(List<ex_Product> list, LayoutInflater inflater, boolean showQuantity) {
		mProductList = list;
		mInflater = inflater;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ex_Product curProduct = mProductList.get(position);
		...
		if (mShowQuantity) {
			item.productQuantity.setText("Quantity: " + ex_ShoppingCartHelper.getProductQuantity(curProduct));
		} else {
			// Hid the view
